...
<head>
  <meta charset="utf-8">
  <title>Sejarah Sekolah - SMK Nasional Nganjuk</title>
...
<!-- Halaman Sejarah -->
  <main class="main">
            ...
            <div class="container position-relative z-2">
                <div class="row justify-content-center align-items-center" style="min-height:70vh;">
                    <div class="col-lg-10 text-center text-white">
                        <h1 class="display-2 fw-bold mb-3 text-white" style="line-height:1.1;">Sejarah SMK Nasional Nganjuk</h1>
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="">
      <p>
        SMK Nasional Nganjuk didirikan pada tahun <strong>2001</strong> sebagai salah satu bentuk kontribusi nyata dalam dunia pendidikan kejuruan di Kabupaten Nganjuk.
        Awalnya sekolah ini hanya memiliki satu program keahlian, yaitu <em>Teknik Komputer dan Jaringan</em>, dengan jumlah siswa tidak lebih dari 50 orang.
      </p>
      <p>
        Seiring berjalannya waktu, SMK Nasional terus berkembang. Pada tahun 2005, dibuka jurusan baru seperti <em>Akuntansi</em> dan <em>Administrasi Perkantoran</em>.
        Fasilitas sekolah pun terus ditingkatkan, termasuk pembangunan laboratorium komputer, bengkel praktik, serta ruang multimedia.
      </p>
      <p>
        Kini, SMK Nasional Nganjuk menjadi salah satu sekolah kejuruan unggulan di daerah, dengan berbagai prestasi akademik maupun non-akademik yang membanggakan.
      </p>
      <p>
        Komitmen kami adalah mencetak lulusan yang <strong>berakhlak mulia, kompeten di bidangnya, dan siap bersaing di dunia kerja maupun melanjutkan ke perguruan tinggi</strong>.
      </p>
    </div>
  </main>
