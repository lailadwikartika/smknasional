...
<head>
  <meta charset="utf-8">
  <title>Fasilitas Sekolah - SMK Nasional Nganjuk</title>
...
<!-- Konten Fasilitas Sekolah -->
<main class="container py-6">
  <section id="" class="">
  <h1 class="text-center mb-4">Fasilitas SMK Nasional Nganjuk</h1>
  ...
  @forelse($fasilitas as $data)
    <tr>
      ...
      <td class="text-center">
        @if ($data->foto)
          <img src="{{ asset('storage/' . $data->foto) }}" alt="{{ $data->nama_fasilitas }}" width="100">
        @else
