...
<head>
    ...
    <title>Bursa Kerja Khusus (BKK)</title>
...
<body>
    ...
    @endif
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('bkk.destroy', $bkk->id_bkk) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                                        @csrf
                                                        @method('DELETE')
