                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        @forelse($data as $strukturorganisasi)
                                        <tr>
                                            <td>
                                                @if ($strukturorganisasi->foto)
                                                <img src="{{ asset('storage/' . $strukturorganisasi->foto) }}" alt="Foto"
                                            ...
                                            <td>
                                                <!-- Edit button -->
                                                <a href="{{ route('struktur-organisasi.edit', $strukturorganisasi->id_struktur_organisasi) }}"
                                                    class="btn btn-sm btn-warning me-1">
                                                    <i class="bi bi-pencil-square"></i> Edit
                                                </a>

                                                <!-- Delete form -->
                                                <form action="{{ route('struktur-organisasi.destroy', $strukturorganisasi->id_struktur_organisasi) }}"
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="6" class="text-center">Belum ada Struktur Organisasi</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
