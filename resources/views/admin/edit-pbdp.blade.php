...
<head>
    ...
    <title>Edit Jalur PPDB - SMK Nasional Nganjuk</title>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('pbdp.update', $pbdp->id_pbdp) }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea id="deskripsi" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="4" placeholder="Masukkan deskripsi singkat jalur pendaftaran">{{ old('deskripsi', $pbdp->deskripsi) }}</textarea>
                                        @error('deskripsi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-3 col-form-label">Upload Brosur (jpg, jpeg, png)</label>
                                    <div class="col-sm-9">
                                        @if ($pbdp->foto)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $pbdp->foto) }}" alt="Foto Lama"
