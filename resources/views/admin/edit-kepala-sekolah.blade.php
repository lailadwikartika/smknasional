...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1 class="fw-bold">Edit Data Kepala Sekolah</h1>
            <nav>
                <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-bold">Edit Data Kepala Sekolah</h5>
                            ...
                            <form action="{{ route('kepala-sekolah.update', $kepala->id_kepala_sekolah) }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    <label for="nama" class="col-sm-3 col-form-label fw-bold">Nama Kepala Sekolah</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row mb-3">
                                    <label for="nip_nuptk" class="col-sm-3 col-form-label fw-bold">NIP / NUPTK</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        @if ($kepala->foto)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $kepala->foto) }}" alt="Foto Lama"
